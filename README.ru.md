...
<sup>**v4.4.0** · 17 августа 2026</sup>
...
[![Версия](https://img.shields.io/badge/версия-4.4.0-5fd0e2?style=flat-square)]()
...
- **Убрана неровность на плотном материале.** Клиппер слишком резко перестраивал свою
  форму, и на насыщенном миксе это слышалось как подрагивание звука. Теперь перестройка
  плавная, и верх, ради которого режим и существует, при этом не теряется
