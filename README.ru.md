...
<sup>**v4.7.0** · 16 сентября 2026</sup>
...
[![Версия](https://img.shields.io/badge/версия-4.7.0-5fd0e2?style=flat-square)]()
...
## v4.7.0 · 16 сентября 2026

- **У каждой полосы появилась своя громкость.** В режиме ALL MIX рядом с ручкой сжатия
  теперь стоит тонкая полоска: она поднимает или опускает свой диапазон *до* того, как до
  него доберётся компрессор. В этом и смысл — полосу, которую компрессор не замечает
  из-за тихого уровня, можно подать ему громче, а ту, что перебивает соседние, придержать,
  и при этом не менять силу сжатия ни у одной из них
- **Режим T7 убран с панели.** Он был экспериментом, который так и не довели до конца, а
  на переключателе только провоцировал выбрать недоделанное. SMART и T6 не изменились,
  и всё, что уже настроено, звучит ровно так же
