...
<sup>**v4.5.2** · 4 сентября 2026</sup>
...
[![Версия](https://img.shields.io/badge/версия-4.5.2-5fd0e2?style=flat-square)]()
...
> **Версия для macOS сейчас 4.4.1** — на несколько выпусков позади. Она работает как и
