...
<sup>**v4.5.0** · 1 сентября 2026</sup>
...
[![Версия](https://img.shields.io/badge/версия-4.5.0-5fd0e2?style=flat-square)]()
...
> **Версия для macOS сейчас 4.4.2** — на два выпуска позади. Она работает как и
